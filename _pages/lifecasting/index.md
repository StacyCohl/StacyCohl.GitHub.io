...
gallery1:
  - url: /assets/images/life/face_in_a_box_2_large.jpeg
    ...
    title: "Hydrocal face cast detail showing single captured eyelash from molding process (note: model reported no discomfort upon de-molding)"
...
gallery3:   
  ...
  - url: /assets/images/life/dead_hand_3_large.jpeg
    ...
    alt: "close up of back of the hand cast from the thumb joint looking over the knuckles showing deep skin wrinkles and and network of protruding veins"
    title: "Hydrocal hand cast with ‘80s-zombie-leaning paint treatment"
  - url: /assets/images/life/dead_hand_2_large.jpeg
    image_path: assets/images/life/dead_hand_2_thumb.jpeg
    alt: "same cast of older man's hand and wrist in even lighting lying palm-down, positioned with thumb in the foreground"
    title: "Hydrocal hand cast with ‘80s-zombie-leaning paint treatment"
gallery4:
...
gallery6:
  ...
  - url: /assets/images/life/nearly_smiling_fresh_large.jpeg
    ...
    alt: "the same cast from previous image but with little chunks of pink alginate still stuck in the teeth (and very few surface bubbles, thanks very much!)"
...
gallery7:
  - url: /assets/images/life/kiss_fresh_large.jpeg
    ...
    title: "Initial Hydrocal cast of model’s lips, unaltered, 2023"
...
{% include gallery id="gallery1" layout="half" caption="Hydrocal life cast of upper face from alginate and plaster bandage mold, mounted in a cigar box, 2019" %}

## D'ed Hand

{% include gallery id="gallery3" layout="half" caption="Hydrocal life cast of hand and wrist from alginate mold; finished with acrylics and PVC clear coat, 2018" %}

## FriendFace

{% include gallery id="gallery5" layout="half" caption="Hydrocal life cast of lower face from alginate and plaster bandage mold, 2023" %}

## Nearly Smiling

{% include gallery id="gallery6" layout="half" caption="Hydrocal life cast using alginate mold with plaster bandage shell, test of including teeth in life cast; test of capturing subtly of facial expressions, 2019" %}

## Proofs Of Life

{% include gallery id="gallery7" layout="half" caption="Hydrocal life casts from alginate molds" %}
